...
final class CPUExecuteINXTests: XCTestCase {
    private var cpu: CPU!
    ...
    func test_INX_IMPL() throws {
        let opcode = CPU.Instruction.INX_OPCODE.IMPL
        ...
        XCTAssertEqual(cpu.registers.X, 0x38)
    ...
    func test_INX_IMPL_overflow() throws {
        let opcode = CPU.Instruction.INX_OPCODE.IMPL
